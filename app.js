"use strict";
var express 		= 	require("express"),//mindware
	app				= 	express(),
	cons 			=	require("consolidate"),
	puerto 			= 	process.env.PORT || 3000,
	bodyParser 		= 	require('body-parser'),//jason
	...
	passport.use(new LocalStrategy(function(username, password, done)
	{
		...
		var sql = "select clave, usuario from users where usuario = '" + username + "'"; //VARIABLE QUE GUARDARÁ LA SENTENCIA SQL...
